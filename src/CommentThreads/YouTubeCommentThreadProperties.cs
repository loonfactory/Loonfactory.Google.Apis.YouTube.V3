...
public class YouTubeCommentThreadProperties : YouTubeProperties
{
    ...
    public YouTubeCommentThreadProperties()
    { }

    public YouTubeCommentThreadProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public YouTubeCommentThreadProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
    ...
    public YouTubeCommentThreadModerationStatus? ModerationStatus
    {
        get => GetParameter<YouTubeCommentThreadModerationStatus>(ModerationStatusKey);
        set => SetParameter(ModerationStatusKey, value);
    }

    public YouTubeCommentThreadOrder? Order
    {
        get => GetParameter<YouTubeCommentThreadOrder>(OrderKey);
