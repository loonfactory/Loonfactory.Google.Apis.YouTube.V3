...
public class I18nRegionsService(
    IYouTubeHandlerProvider handlers,
    IAccessTokenProvider accessTokenProvider) : II18nRegionsService
{
    ...
    public async Task<I18nRegionListResponse> ListAsync(StringValues part, string? hl = "en_US", CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(part);

        var handler = await Handlers.GetHandlerAsync<I18nRegionHandler>()
