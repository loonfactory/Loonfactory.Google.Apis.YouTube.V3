...
/// </summary>
public class YouTubeChannelSectionProperties : YouTubeProperties
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="YouTubeChannelSectionProperties"/>.
    /// </summary>
    public YouTubeChannelSectionProperties()
    { }
    ...
    /// </summary>
    /// <inheritdoc />
    public YouTubeChannelSectionProperties(IDictionary<string, string?> items)
        : base(items)
    { }
    ...
    /// </summary>
    /// <inheritdoc />
    public YouTubeChannelSectionProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
