...
public class PlaylistItemProperties : YouTubeProperties
{
    ...
    public PlaylistItemProperties()
    { }

    public PlaylistItemProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public PlaylistItemProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
