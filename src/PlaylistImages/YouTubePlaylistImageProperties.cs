...
public class YouTubePlaylistImageProperties : YouTubeProperties
{
    ...
    public YouTubePlaylistImageProperties()
    { }

    public YouTubePlaylistImageProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public YouTubePlaylistImageProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
