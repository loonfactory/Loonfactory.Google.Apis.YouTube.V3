...
public class YouTubePlaylists(
    ...
    IAccessTokenProvider accessTokenProvider) : IYouTubePlaylists
{
    ...
    public Task<YouTubePlaylistListResponse> ListByIdAsync(
        StringValues part,
        StringValues id,
    ...
    public Task<YouTubePlaylistListResponse> ListByChannelIdAsync(
        StringValues part,
        string channelId,
        uint? maxResults = null,
        string? onBehalfOfContentOwner = null,
    ...
    public Task<YouTubePlaylistListResponse> ListByMineAsync(
        StringValues part,
        bool mine,
        uint? maxResults = null,
        string? onBehalfOfContentOwner = null,
    ...
    private async Task<YouTubePlaylistListResponse> ListAsync(
        StringValues part,
    ...
    {
        var handler = await Handlers.GetHandlerAsync<YouTubePlaylistHandler>()
                                     .ConfigureAwait(false) ?? throw new InvalidOperationException("YouTubePlaylistItemHandler could not be obtained.");

        var properties = new YouTubePlaylistProperties
        {
            Part = part,
    ...
    public Task<YouTubePlaylistResource> InsertAsync(
        StringValues part,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        async Task<YouTubePlaylistResource> InternalInsertAsync(
            StringValues part,
            YouTubePlaylistResource resource,
            string? onBehalfOfContentOwner,
            string? onBehalfOfContentOwnerChannel,
    ...
    public Task<YouTubePlaylistResource> UpdateAsync(
        StringValues part,
        YouTubePlaylistResource resource,
        string? onBehalfOfContentOwner = null,
        CancellationToken cancellationToken = default)
    {
        ...
        async Task<YouTubePlaylistResource> InternalUpdateAsync(
            StringValues part,
            YouTubePlaylistResource resource,
            string? onBehalfOfContentOwner,
            CancellationToken cancellationToken)
