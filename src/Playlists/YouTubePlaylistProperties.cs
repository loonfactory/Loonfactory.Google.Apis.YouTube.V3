...
public class YouTubePlaylistProperties : YouTubeProperties
{
    ...
    public YouTubePlaylistProperties()
    { }

    public YouTubePlaylistProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public YouTubePlaylistProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
