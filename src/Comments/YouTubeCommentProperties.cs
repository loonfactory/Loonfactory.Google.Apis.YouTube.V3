...
public class YouTubeCommentProperties : YouTubeProperties
{
    ...
    public YouTubeCommentProperties()
    { }

    public YouTubeCommentProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public YouTubeCommentProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
    ...
    public YouTubeCommentModerationStatus? ModerationStatus
    {
        get => GetParameter<YouTubeCommentModerationStatus>(ModerationStatusKey);
