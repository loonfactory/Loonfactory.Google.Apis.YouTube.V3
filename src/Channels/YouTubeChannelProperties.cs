...
public class YouTubeChannelProperties : YouTubeProperties
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="YouTubeChannelProperties"/>.
    /// </summary>
    public YouTubeChannelProperties()
    { }
    ...
    /// </summary>
    /// <inheritdoc />
    public YouTubeChannelProperties(IDictionary<string, string?> items)
        : base(items)
    { }
    ...
    /// </summary>
    /// <inheritdoc />
    public YouTubeChannelProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
