...
public class YouTubeDataApiBuilder(IServiceCollection services)
{
    ...
    public virtual YouTubeDataApiBuilder AddPlaylistImages<TYouTubePlaylistImages, THandler>()
        where TYouTubePlaylistImages : class, IPlaylistImagesService
        where THandler : class, IPlaylistImageHandler
    {
        Services.TryAddScoped<IPlaylistImagesService, TYouTubePlaylistImages>();
        AddHandler<THandler>();
    ...
    public virtual YouTubeDataApiBuilder AddSubscriptions<TYouTubeSubscriptions, THandler>()
        where TYouTubeSubscriptions : class, ISubscriptionService
        where THandler : class, ISubscriptionHandler
    {
        Services.TryAddScoped<ISubscriptionService, TYouTubeSubscriptions>();
        AddHandler<THandler>();

        return this;
    }

    public virtual YouTubeDataApiBuilder AddVideoAbuseReportReasons<TYouTubeVideoAbuseReportReasons, THandler>()
        where TYouTubeVideoAbuseReportReasons : class, IVideoAbuseReportReasonsService
    ...
    public virtual YouTubeDataApiBuilder AddThumbnails<TYouTubeThumbnails, THandler>()
        where TYouTubeThumbnails : class, IThumbnailService
