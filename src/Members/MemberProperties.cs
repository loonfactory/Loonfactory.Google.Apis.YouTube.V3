...
public class MemberProperties : YouTubeProperties
{
    ...
    public MemberProperties(IDictionary<string, string?> items)
        : base(items)
    { }

    public MemberProperties(IDictionary<string, string?> items, IDictionary<string, object?> parameters)
